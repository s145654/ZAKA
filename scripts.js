// ZAKA Project Scripts

// 2. Dynamic Tables & Data Management
// Object Constructors
...
function validateQuestionnaire(event) {
    ...
    const agePattern = /^\d{1,2}$/; // 1-2 digits
...
// 5. Fun Page: Drawing Tool (DHTML Concept)
...
// 6. Homepage Banner: Date and Time
